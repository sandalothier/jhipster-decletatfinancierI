package com.fisc.decletatfinancier1.web.rest;

import com.fisc.decletatfinancier1.DecletatfinancierIApp;
...
@SpringBootTest(classes = DecletatfinancierIApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinancierIKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinancierIKafkaProducer producer;

    @Autowired
    private DecletatfinancierIKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinancierIKafkaResource kafkaResource = new DecletatfinancierIKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-i-kafka/publish?message=test"))
