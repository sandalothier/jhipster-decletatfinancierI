package com.fisc.decletatfinancier1.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinancierI");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinancierI");
        ...
        config.getMapConfigs().put("com.fisc.decletatfinancier1.domain.*", initializeDomainMapConfig(jHipsterProperties));
